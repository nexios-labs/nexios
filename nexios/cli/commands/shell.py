...
from nexios.cli.utils import _find_app_module, load_config_module
...
@click.option(
    "--ipython", is_flag=True, help="Force use of IPython shell (default: auto-detect)"
)
def shell(app_path: str = None, config_path: str = None, ipython: bool = False):
    ...
    try:
        ...
        shell_vars = {"app": app, "NexiosApp": type(app), "config": app.config}
