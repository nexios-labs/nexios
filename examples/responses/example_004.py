...
from nexios.http.response import JSONResponse, HTMLResponse, PlainTextResponse, FileResponse, BaseResponse
...
async def file_handler(req, res):
    return FileResponse("examples/respons/example_004.py", content_disposition_type="attachment")
