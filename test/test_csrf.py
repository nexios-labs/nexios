...
class TestCSRFMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_process_response_sets_cookie(self, csrf_middleware, mock_request, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_process_response_disabled_csrf(self, mock_config, mock_request, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_exempt_url_with_sensitive_cookies(self, csrf_middleware, mock_request, mock_response):
        ...
        mock_response.text.assert_called_once_with("CSRF token missing from cookies", status_code=403)
