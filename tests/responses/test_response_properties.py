...
def test_response_status_code_property(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_content_type_property(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_content_length_property(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_method_chaining_all_methods(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_method_chaining_order_independence(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_type_switching(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_headers_preserved_across_response_changes(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_cookies_preserved_across_response_changes(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_get_response_method(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_with_error_status(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_multiple_calls(test_client_factory: Callable[[NexiosApp], TestClient]):
