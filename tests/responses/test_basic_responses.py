...
def test_text_response_with_status_code(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_text_response_with_headers(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_json_response_with_list(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_json_response_with_status_code(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_json_response_with_indent(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_json_response_with_nested_data(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_html_response_with_full_page(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_html_response_with_status_code(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_empty_response_with_status_code(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_content_type_text(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_content_type_json(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_response_content_type_html(test_client_factory: Callable[[NexiosApp], TestClient]):
