...
def test_websocket_json_communication(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_websocket_bytes_communication(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_websocket_with_path_parameters(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_websocket_multiple_messages(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_websocket_router_mounting(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_websocket_multiple_routers(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_websocket_nested_routers(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_websocket_with_query_parameters(test_client_factory: Callable[[NexiosApp], TestClient]):
