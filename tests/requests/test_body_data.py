...
def test_request_json_empty_object(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_json_with_boolean(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_json_with_numbers(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_form_data_urlencoded(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    with test_client_factory(app) as client:
        resp = client.post("/form", data={"username": "john", "email": "john@example.com"})
        data = resp.json()
        assert data["username"] == "john"
        assert data["email"] == "john@example.com"


def test_request_form_data_multiple_values(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_form_data_empty(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_accepts_json_wildcard(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_accepts_html_wildcard(test_client_factory: Callable[[NexiosApp], TestClient]):
