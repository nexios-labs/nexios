...
def test_request_get_client_ip_with_forwarded_for(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_get_client_ip_with_real_ip(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_str_representation(test_client_factory: Callable[[NexiosApp], TestClient]):
    """Test __str__ method"""
    app = NexiosApp()
...
def test_request_origin_without_header(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_build_absolute_uri(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_request_build_absolute_uri_with_query(test_client_factory: Callable[[NexiosApp], TestClient]):
