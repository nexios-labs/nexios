...
def test_route_level_middleware_basic(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_level_middleware_isolated(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_level_middleware_multiple(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_level_middleware_with_decorator(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_level_middleware_modifies_request(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_level_middleware_modifies_response(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_with_app_middleware(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    with test_client_factory(app) as client:
        ...
        assert execution_order.index("app_before") < execution_order.index("route_before")
...
def test_route_middleware_validation(test_client_factory: Callable[[NexiosApp], TestClient]):
    """Test route middleware for input validation"""
    app = NexiosApp()
    
    async def validate_query_middleware(request: Request, response: Response, call_next):
...
def test_route_middleware_rate_limiting(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_middleware_caching(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_middleware_logging(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_route_middleware_different_methods(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    route = Routes("/test", handler, methods=["GET", "POST", "PUT"], middleware=[method_logger_middleware])
    app.router.add_route(route)
...
def test_route_middleware_error_handling(test_client_factory: Callable[[NexiosApp], TestClient]):
