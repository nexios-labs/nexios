...
from nexios.routing import Router, Routes, Group
...
def test_organized_api_structure(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_group_with_different_http_methods(test_client_factory: Callable[[NexiosApp], TestClient]):
