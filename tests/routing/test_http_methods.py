...
def test_route_with_multiple_methods(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_routes_class_with_multiple_methods(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_case_insensitive_methods(test_client_factory: Callable[[NexiosApp], TestClient]):
