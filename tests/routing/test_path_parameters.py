...
def test_multiple_path_parameters(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_path_parameter_from_request_path_params(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_url_for_with_path_parameter(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_url_for_with_multiple_parameters(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_path_parameter_with_special_characters(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_optional_trailing_slash(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_path_params_in_request_object(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_mixed_static_and_dynamic_segments(test_client_factory: Callable[[NexiosApp], TestClient]):
