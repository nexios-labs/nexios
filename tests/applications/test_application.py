...
@app.route("/multiple_methods",methods=["GET","POST","PUT","DELETE","HEAD","OPTIONS","PATCH"])
...
def test_url_for_with_param(client:TestClient):
    assert app.url_for("route-with-name-and-param",param="test") == "/route-with-name-and-param/test"
