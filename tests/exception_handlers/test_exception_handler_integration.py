...
def test_exception_handler_with_middleware(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_middleware_order(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_middleware_state_access(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_with_nested_routers(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def router_error_handler(request: Request, response: Response, exc: RouterError):
...
def test_exception_handler_different_routers(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def shared_error_handler(request: Request, response: Response, exc: SharedError):
        return response.status(400).json({
            "error": "Shared error",
            "message": str(exc)
        })
...
def test_exception_handler_different_methods(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def method_error_handler(request: Request, response: Response, exc: MethodError):
        return response.status(400).json({
            "error": str(exc),
...
def test_exception_handler_with_query_params(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def query_error_handler(request: Request, response: Response, exc: QueryError):
...
def test_exception_handler_with_path_params(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def item_not_found_handler(request: Request, response: Response, exc: ItemNotFoundError):
...
def test_exception_handler_with_request_body(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_with_request_headers(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def header_error_handler(request: Request, response: Response, exc: HeaderError):
...
def test_exception_handler_with_cookies(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def session_error_handler(request: Request, response: Response, exc: SessionError):
...
def test_exception_handler_priority_specific_over_general(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def specific_handler(request: Request, response: Response, exc: SpecificError):
...
def test_exception_handler_complex_scenario(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def complex_error_handler(request: Request, response: Response, exc: ComplexError):
        execution_log.append("error_handler")
...
def test_exception_handler_no_handler_defined(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_with_successful_request(test_client_factory: Callable[[NexiosApp], TestClient]):
