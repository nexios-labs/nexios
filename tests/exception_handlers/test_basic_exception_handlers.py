...
def test_exception_handler_custom_exception(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def custom_error_handler(request: Request, response: Response, exc: CustomError):
...
def test_exception_handler_http_exception(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_not_found_exception(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_value_error(test_client_factory: Callable[[NexiosApp], TestClient]):
    """Test handling ValueError"""
    app = NexiosApp()
    
    async def value_error_handler(request: Request, response: Response, exc: ValueError):
        return response.status(400).json({
            "error": "ValueError",
            "message": str(exc)
        })
...
def test_exception_handler_type_error(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_multiple_exceptions(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_decorator_style(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def handle_custom_exception(request: Request, response: Response, exc: CustomException):
...
def test_exception_handler_status_code_404(test_client_factory: Callable[[NexiosApp], TestClient]):
    """Test handling 404 status code"""
    app = NexiosApp()
    
    async def custom_404_handler(request: Request, response: Response, exc: HTTPException):
...
def test_exception_handler_status_code_500(test_client_factory: Callable[[NexiosApp], TestClient]):
    """Test handling 500 status code"""
    app = NexiosApp()
    
    async def custom_500_handler(request: Request, response: Response, exc: HTTPException):
...
def test_exception_handler_status_code_401(test_client_factory: Callable[[NexiosApp], TestClient]):
    """Test handling 401 status code"""
    app = NexiosApp()
    
    async def custom_401_handler(request: Request, response: Response, exc: HTTPException):
...
def test_exception_handler_with_custom_headers(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def rate_limit_handler(request: Request, response: Response, exc: RateLimitError):
        return response.status(429).set_header("Retry-After", "60").json({
...
def test_exception_handler_http_exception_with_headers(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_inheritance(test_client_factory: Callable[[NexiosApp], TestClient]):
...
def test_exception_handler_specific_over_base(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def specific_error_handler(request: Request, response: Response, exc: SpecificError):
...
def test_exception_handler_access_request_data(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def validation_error_handler(request: Request, response: Response, exc: ValidationError):
        return response.status(400).json({
...
def test_exception_handler_with_exception_details(test_client_factory: Callable[[NexiosApp], TestClient]):
    ...
    async def detailed_error_handler(request: Request, response: Response, exc: DetailedError):
        return response.status(400).json({
            "error": "DetailedError",
            "message": str(exc),
            "code": exc.code
